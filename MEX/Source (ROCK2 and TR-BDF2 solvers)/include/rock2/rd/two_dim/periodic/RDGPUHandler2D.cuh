...
protected:
	...
	unsigned int m_block_size_initial = 512;
	unsigned int m_block_size_rec = 16;
	unsigned int m_block_size_finish = 16;
	unsigned int m_block_size_spectral_radius = 512;
...
template<typename value_type, typename index_type>
void RDGPUHandler2D<value_type, index_type>::execute_initial_stage(R2GPUScheduler<value_type, index_type>& scheduler, index_type queue_length, size_t run_indices_offset)
{
	unsigned int block_number = this->find_block_number(
		static_cast<unsigned int>(this->m_grid_size * queue_length),
...
template<typename value_type, typename index_type>
void RDGPUHandler2D<value_type, index_type>::execute_rec_stage(R2GPUScheduler<value_type, index_type>& scheduler, index_type queue_length, size_t run_indices_offset)
{
	unsigned int block_number = this->find_block_number(
	...
	dim3 grid{ block_number, block_number, queue_length };
	dim3 block{ this->m_block_size_rec, this->m_block_size_rec, 1 };
...
template<typename value_type, typename index_type>
void RDGPUHandler2D<value_type, index_type>::execute_fp_stage(R2GPUScheduler<value_type, index_type>& scheduler, index_type queue_length, size_t run_indices_offset)
{
	unsigned int block_number = this->find_block_number(
		static_cast<unsigned int>(this->m_grid_resolution),
	...
	dim3 grid{ block_number, block_number, queue_length };
	dim3 block{ this->m_block_size_finish, this->m_block_size_finish, 1 };
...
template<typename value_type, typename index_type>
void RDGPUHandler2D<value_type, index_type>::execute_spectral_radius_stage(R2GPUScheduler<value_type, index_type>& scheduler, index_type queue_length, size_t run_indices_offset)
{
